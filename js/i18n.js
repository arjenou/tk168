window.TK168I18N = (() => {
  ...
  const messages = {
    zh: {
      ...
      'home.loadMore': '加载更多',
      'home.inventoryShownAll': '已显示全部 {count} 辆',
      'brand.eyebrow': '精选品牌库',
      ...
      'footer.store1Region': '日本 · 东京',
      'footer.store1Name': '龟户店',
      'footer.store1Meta': '东京都江东区龟户<br>地址准备中',
      'footer.store2Region': '日本 · 大阪',
      'footer.store2Name': '大阪店',
      'footer.store2Meta': '大阪府<br>地址准备中',
      'footer.store3Region': '马来西亚',
      'footer.store3Name': '马来西亚分店',
      'footer.store3Meta': 'Kuala Lumpur, Malaysia<br>地址准备中',
    ...
    ja: {
      ...
      'home.loadMore': 'もっと見る',
      'home.inventoryShownAll': '全 {count} 台を表示しています',
      ...
      'footer.store1Region': '日本 · 東京',
      'footer.store1Name': '亀戸店',
      'footer.store1Meta': '東京都江東区亀戸<br>住所準備中',
      'footer.store2Region': '日本 · 大阪',
      'footer.store2Name': '大阪店',
      'footer.store2Meta': '大阪府<br>住所準備中',
      'footer.store3Region': 'マレーシア',
      'footer.store3Name': 'マレーシア拠点',
      'footer.store3Meta': 'Kuala Lumpur, Malaysia<br>住所準備中',
    ...
    en: {
      ...
      'home.inventoryShownAll': 'Showing all {count} vehicles',
      ...
      'footer.store1Region': 'Japan · Tokyo',
      'footer.store1Name': 'Kameido',
      'footer.store1Meta': 'Koto-ku, Tokyo<br>Address coming soon',
      'footer.store2Region': 'Japan · Osaka',
      'footer.store2Name': 'Osaka',
      'footer.store2Meta': 'Osaka Prefecture<br>Address coming soon',
      'footer.store3Region': 'Malaysia',
      'footer.store3Name': 'Malaysia branch',
      'footer.store3Meta': 'Kuala Lumpur, Malaysia<br>Address coming soon',
