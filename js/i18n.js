window.TK168I18N = (() => {
  ...
  const messages = {
    zh: {
      ...
      'footer.stores.tokyo.name': '新大久保店',
      'footer.stores.tokyo.postal': '169-0073',
      'footer.stores.tokyo.street': '东京都新宿区百人町3丁目9-6 101',
      'footer.stores.tokyo.phoneLine': '电话：070-4286-2253',
      'footer.stores.tokyo.emailLine': '邮箱：spacekart@tk168.co.jp',
      'footer.stores.saitama.eyebrow': '日本 · 东京',
      'footer.stores.saitama.name': 'さいたま店',
      'footer.stores.saitama.postal': '339-0035',
      'footer.stores.saitama.street': '埼玉県さいたま市岩槻区笹久保新田',
      ...
      'footer.stores.osaka.postal': '595-0042',
      'footer.stores.osaka.street': '大阪府泉大津市高津町12-11',
      ...
      'footer.stores.malaysia.postal': 'Kuala Lumpur, Malaysia',
      'footer.stores.malaysia.street': '地址准备中',
    ...
    ja: {
      ...
      'footer.stores.tokyo.name': '新大久保店',
      'footer.stores.tokyo.postal': '169-0073',
      'footer.stores.tokyo.street': '東京都新宿区百人町３丁目９−６ 101',
      'footer.stores.tokyo.phoneLine': 'TEL：070-4286-2253',
      'footer.stores.tokyo.emailLine': 'EMAIL：spacekart@tk168.co.jp',
      ...
      'footer.stores.osaka.name': '大阪店',
      'footer.stores.osaka.postal': '595-0042',
      'footer.stores.osaka.street': '大阪府泉大津市高津町１２−１１',
      ...
      'footer.stores.malaysia.postal': 'Kuala Lumpur, Malaysia',
      'footer.stores.malaysia.street': '住所準備中',
    ...
    en: {
      ...
      'footer.stores.tokyo.eyebrow': 'JAPAN · TOKYO',
      'footer.stores.tokyo.name': 'Shin-Okubo Store',
      'footer.stores.tokyo.postal': 'Tokyo 169-0073, Japan',
      'footer.stores.tokyo.street': '101, 3-9-6 Hyakunincho, Shinjuku-ku',
      'footer.stores.tokyo.phoneLine': 'TEL: 070-4286-2253',
      'footer.stores.tokyo.emailLine': 'EMAIL: spacekart@tk168.co.jp',
      'footer.stores.saitama.eyebrow': 'JAPAN · TOKYO',
      'footer.stores.saitama.name': 'Saitama Store',
      'footer.stores.saitama.postal': '339-0035',
      'footer.stores.saitama.street': 'Sasakubo Shinden, Iwatsuki-ku, Saitama-shi, Saitama',
      'footer.stores.saitama.phoneLine': 'TEL: 048-796-4907',
      'footer.stores.saitama.faxLine': 'FAX: 048-796-4946',
      'footer.stores.saitama.emailLine': 'EMAIL: AUTO@tk168.co.jp',
      'footer.stores.osaka.eyebrow': 'JAPAN · OSAKA',
      'footer.stores.osaka.name': 'Osaka Store',
      'footer.stores.osaka.postal': 'Osaka 595-0042, Japan',
      'footer.stores.osaka.street': '12-11 Takatsu-cho, Izumiotsu-shi',
      'footer.stores.osaka.phoneLine': 'TEL: 072-592-9577',
      'footer.stores.osaka.faxLine': 'FAX: 072-592-9631',
      'footer.stores.osaka.emailLine': 'EMAIL: OSAKA@tk168.co.jp',
      'footer.stores.malaysia.eyebrow': 'MALAYSIA',
      ...
      'footer.stores.malaysia.postal': 'Kuala Lumpur, Malaysia',
      'footer.stores.malaysia.street': 'Address in preparation',
