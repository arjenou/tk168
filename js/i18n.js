window.TK168I18N = (() => {
  ...
  const messages = {
    zh: {
      ...
      'footer.stores.tokyo.address': '〒169-0073<br>东京都新宿区百人町3丁目9-6 101',
    ...
    ja: {
      ...
      'footer.stores.tokyo.name': '新大久保店',
      'footer.stores.tokyo.address': '〒169-0073<br>東京都新宿区百人町３丁目９−６ 101',
    ...
    en: {
      ...
      'footer.stores.tokyo.address': '101, 3-9-6 Hyakunincho, Shinjuku-ku<br>Tokyo 169-0073, Japan',
      'footer.stores.tokyo.phoneLine': 'TEL: 070-4286-2253',
      'footer.stores.tokyo.emailLine': 'EMAIL: spacekart@tk168.co.jp',
      'footer.stores.saitama.eyebrow': 'JAPAN · TOKYO',
