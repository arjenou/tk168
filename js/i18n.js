window.TK168I18N = (() => {
  ...
  const messages = {
    zh: {
      ...
      'footer.stores.osaka.address': '大阪府<br>地址准备中',
    ...
    ja: {
      ...
      'footer.stores.osaka.name': '大阪店',
      'footer.stores.osaka.address': '大阪府<br>住所準備中',
    ...
    en: {
      ...
      'footer.stores.osaka.address': 'Osaka Prefecture<br>Address in preparation',
      'footer.stores.malaysia.eyebrow': 'MALAYSIA',
