#!/usr/bin/env node
// Generates schema/rental-seed.sql from legacy seed data in worker/schema/legacy-seed-data.mjs.

import { writeFileSync } from "node:fs";
import { resolve, dirname } from "node:path";
import { fileURLToPath } from "node:url";
import { baseVehicles, defaultBenefits, defaultFeatures, rentalProfiles } from "./legacy-seed-data.mjs";
